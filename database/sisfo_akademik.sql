...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2024 at 05:50 AM
...
(38, 1, 2020051074021, 3, 13, 'ganjil', 75);
...
(15, 2020051074080, 100, 100, 90, 90, 95, 'A', 'Sangat Baik', 380, 95, 75, 25),
(16, 2020051074080, 100, 100, 90, 90, 95, 'A', 'Sangat Baik', 380, 95, 75, 23),
(17, 2020051074080, 100, 100, 90, 90, 95, 'A', 'Sangat Baik', 380, 95, 75, 38);
...
(2020051074080, 'cia', '1f6fda80636fb763bef93193444b3f36', 'abe@gmail', 'siswa', 'N');
...
(16, 2022051074048, 1, 6),
(17, 2022051074050, 1, 6),
(18, 2020051074080, 3, 6),
(19, 2020051074023, 3, 6);
...
--
ALTER TABLE `ekstra_siswa`
  MODIFY `id_ekstra_siswa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `nilai`
  MODIFY `id_nilai` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `pengguna`
  MODIFY `idu` bigint(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2020051074081;

--
-- AUTO_INCREMENT for table `rombel`
--
ALTER TABLE `rombel`
  MODIFY `id_rombel` bigint(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
